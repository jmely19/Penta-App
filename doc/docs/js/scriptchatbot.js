...
async function callGeminiAPI(prompt) {
    try {
        const systemPrompt = `You are Penta Assistance, a helpful AI assistant for PENTA Financial Education for Youth. You help young people learn about financial literacy, budgeting, saving, investing, and money management. You should be friendly, encouraging, and provide practical financial advice suitable for teenagers and young adults. Always respond in a helpful and educational manner.`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showWelcomeMessage() {
        const welcomeMessages = [
            "¡Hola! Soy Penta Assistance, tu asistente virtual de educación financiera.",
            "¿En qué puedo ayudarte hoy?",
            "Puedes preguntarme sobre ahorro, presupuesto, inversión o cualquier tema financiero."
        ];
